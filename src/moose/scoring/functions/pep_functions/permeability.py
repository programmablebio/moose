...
class Permeability:
    ...
    def __init__(self, tokenizer, base_path, device=None, emb_model=None):
        ...
        self.predictor = xgb.Booster(
            model_file=f"{base_path}/TR2-D2/tr2d2-pep/scoring/functions/classifiers/permeability-xgboost.json"
        )
...
def unittest():
    ...
    seq = [
        "N[C@@H](CCCNC(=N)N)C(=O)N[C@@H](Cc1cNc2c1cc(O)cc2)C(=O)N[C@@H](CC1=CN=C-N1)C(=O)N[C@@H](CCCNC(=N)N)C(=O)N[C@@H](Cc1ccccc1)C(=O)N[C@@H](CCC(=O)O)C(=O)N[C@@H]([C@@H](O)C(C)C)C(=O)N[C@@H](Cc1ccc(O)cc1)C(=O)N[C@H](CC(=CN2)C1=C2C=CC=C1)C(=O)O"
    ]
